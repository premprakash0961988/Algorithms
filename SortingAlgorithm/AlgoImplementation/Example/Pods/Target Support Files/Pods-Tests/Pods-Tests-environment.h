...
// AlgoImplementation
#define COCOAPODS_POD_AVAILABLE_AlgoImplementation
#define COCOAPODS_VERSION_MAJOR_AlgoImplementation 0
#define COCOAPODS_VERSION_MINOR_AlgoImplementation 1
#define COCOAPODS_VERSION_PATCH_AlgoImplementation 0
